...
|Feature|Description|
|---|---|
|**Type**|Saddle joint (functions as ball-and-socket due to articular disk)|
...
### Acromioclavicular Joint (Lateral Clavicular Joint)

|Feature|Description|
|---|---|
|**Type**|Plane joint|
|**Articulation**|Lateral end of clavicle ↔ acromion of scapula|
...
|Feature|Description|
|---|---|
|**Type**|Spheroidal (ball-and-socket) — most mobile joint in the body|
|**Articulation**|Head of humerus ↔ glenoid cavity of scapula|
|**Size mismatch**|Glenoid cavity is 3–4× smaller than humeral head|
|**Glenoid labrum**|Fibrocartilage rim (~5 mm wide at base); enlarges and deepens glenoid slightly|
|**Capsule**|Broad, loose, thin posteriorly; not reinforced by muscle inferiorly → forms **axillary recess** (reserve fold for abduction)|
|**Primary stabilizers**|Rotator cuff tendons (not ligaments/capsule)|
...
|---|---|
|**Coracohumeral ligament**|Base of coracoid process → greater & lesser tubercles. Strong, broad band. Stabilizes long head of biceps tendon|
...
|**Function**|Stabilizes humeral head in glenoid; limits upward movement of humerus|
|**Subacromial bursa**|Located between the arch and rotator cuff tendons inserting on humeral head|

---

### Bursae Communicating with Joint Cavity

|Bursa|Location|
|---|---|
|**Subtendinous bursa of subscapularis**|Between subscapularis and joint capsule; consistently communicates|
...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Trapezius – descending** | • Superior nuchal line & external occipital protuberance  <br>• All cervical spinous processes via nuchal ligament | Lateral third of clavicle                                                                                                                                                                        | CN XI + cervical plexus (C2, C4)          | • Draws scapula obliquely upward  <br>• Rotates glenoid cavity inferiorly  <br>• Tilts head ipsilaterally, rotates contralaterally                       |
| **Trapezius – transverse** | • Broad aponeurosis at T1–T4 spinous processes                                                                     | Acromion                                                                                                                                                                                         | Same                                      | • Retraction (draws scapula medially)                                                                                                                    |
| **Trapezius – ascending**  | • Spinous processes T5–T12                                                                                         | Scapular spine                                                                                                                                                                                   | Same                                      | • Draws scapula medially downward  <br>• Supports rotating action of descending part                                                                     |
| **Trapezius – entire**     |                                                                                                                    |                                                                                                                                                                                                  |                                           | • Steadies scapula on thorax                                                                                                                             |
| **Sternocleidomastoid**    | • Sternal head: manubrium  <br>• Clavicular head: medial third of clavicle                                         | Mastoid process + superior nuchal line                                                                                                                                                           | CN XI + cervical plexus (C2, C3)          | • Unilateral: tilts head ipsilaterally, rotates contralaterally  <br>• Bilateral: extends head  <br>• Assists respiration when head fixed                |
| **Serratus anterior**      | • Ribs 1–9                                                                                                         | • ① Superior part: superior angle (costal + dorsal surfaces)  <br>• ② Intermediate part: medial border (costal surface)  <br>• ③ Inferior part: inferior angle + costal surface of medial border | Long thoracic nerve (C5–C7)               | • Entire: protracts scapula, elevates ribs  <br>• Inferior part: rotates glenoid superiorly → arm elevation >90°  <br>• Superior part: lowers raised arm |
| **Subclavius**             | • 1st rib (chondro-osseous junction)                                                                               | Inferior surface of clavicle (lateral third)                                                                                                                                                     | Nerve to subclavius (C5, C6)              | • Steadies clavicle in SC joint                                                                                                                          |
| **Pectoralis minor**       | • Ribs 3–5                                                                                                         | Coracoid process                                                                                                                                                                                 | Medial & lateral pectoral nerves (C8, T1) | • Draws scapula downward  <br>• Rotates glenoid inferiorly  <br>• Assists respiration                                                                    |
| **Levator scapulae**       | • Transverse processes C1–C4                                                                                       | Superior angle of scapula                                                                                                                                                                        | Dorsal scapular nerve + C3, C4            | • Draws scapula medially upward  <br>• Inclines neck ipsilaterally (scapula fixed)                                                                       |
...
|Muscle|Origin|Insertion|Innervation|Action|
|---|---|---|---|---|
|**Supraspinatus**|• Supraspinous fossa|Greater tubercle|Suprascapular nerve (C4–C6)|• Abduction (initiates first 15°)|
...
|Muscle|Origin|Insertion|Innervation|Action|
|---|---|---|---|---|
|**Deltoid**|• ① Clavicular part: lateral third of clavicle  <br>• ② Acromial part: acromion  <br>• ③ Spinal part: scapular spine|Deltoid tuberosity of humerus|Axillary nerve (C5, C6)|• Clavicular: flexion, internal rotation, adduction  <br>• Acromial: abduction  <br>• Spinal: extension, external rotation, adduction  <br>• 60–90° abduction: all parts assist|
|**Latissimus dorsi**|• Vertebral: spinous processes T7–T12  <br>• Thoracolumbar fascia (all lumbar + sacrum)  <br>• Iliac: posterior third of iliac crest  <br>• Costal: ribs 9–12  <br>• Scapular: inferior angle of scapula|Floor of intertubercular groove|Thoracodorsal nerve (C6–C8)|• Internal rotation  <br>• Adduction  <br>• Extension  <br>• Assists expiration ("cough muscle")|
