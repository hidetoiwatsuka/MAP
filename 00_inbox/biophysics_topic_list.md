...
|Lab #|Topic|
|---|---|
|2|Microscopy I — Optics, image formation|
|3|Microscopy II — Special microscopes, resolution, contrast|
|5|Light Emission — Emission spectroscopy|
|6|Light Absorption — Spectrophotometry|
|7|Polarimetry — Optical activity of sugar solutions|
|8|Optics of the Eye|
...
|Lab #|Topic|
|---|---|
|4|Refractometry — Concentration measurement|
|21|Resonance — Elasticity, oscillations, atomic force microscopy|

---

## 3. Radiation & Nuclear Medicine
...
|Lab #|Topic|
|---|---|
|9|Nuclear Medicine — Measurement fundamentals|
|10|Gamma Absorption — Radiation protection|
|11|Gamma Energy — Dual isotope labeling|
|12|Isotope Diagnostics|
|15|Dosimetry — Dose measurement, radiation protection|
|16|UV-Dosimetry — Biologically effective UV dose|
...
| No         | Date       | Topic                                   | Lecturer    |
| ---------- | ---------- | --------------------------------------- | ----------- |
| Bio II - 1 | 2026.02.18 | [Generation and properties of X-ray.](Generation%20and%20properties%20of%20X-ray..md) | Kellermayer |
| Bio II - 2 | 2026.02.25 | [Fundamentals of X-ray diagnostics.](Fundamentals%20of%20X-ray%20diagnostics..md)  | Balog Erika |

### Practices

|Lab #|Topic|
|---|---|
|13|X-Ray — Generation and absorption|
|14|CAT-Scan — X-ray diagnostics and CT principles|
...
|Lab #|Topic|
|---|---|
|20|Ultrasound — Diagnostic sonography, therapeutic applications|

---

## 6. Thermodynamics & Transport
...
|Lab #|Topic|
|---|---|
|28|Flow — Fluid flow, electrical model of vascular system|
|29|Diffusion — Material transport, diffusion coefficient|

---

## 7. Electronics & Signals
...
|Lab #|Topic|
|---|---|
|17|Measurement Techniques — Analog and digital instruments|
|18|Amplifier — Characteristics of electronic amplifier|
|19|Sine Wave Oscillator — High frequency waves, medical applications|
|22|Pulse Generator — Generation and counting of electric pulses|

---

## 8. Bioelectricity & Sensory Organs
...
| Lab # | Topic                                                   |
| ----- | ------------------------------------------------------- |
| 23    | Coulter Counter — Electronic counting of blood elements |
...
## 9. Biomolecules & Methods

### Lectures

| No          | Date       | Topic                                                                     | Lecturer    |
| ----------- | ---------- | ------------------------------------------------------------------------- | ----------- |
| Bio II - 9  | 2026.04.15 | Building blocks of life: water, macromolecules, supramolecular systems.   | Kellermayer |
| Bio II - 11 | 2026.04.29 | Biomolecular structure & dynamics: X-ray diffraction, mass spectrometry.  | Fehér Bence |
| Bio II - 12 | 2026.05.06 | Biomolecular structure & dynamics: radiospectroscopies, MRI fundamentals. | Kellermayer |

### Practices

|Lab #|Topic|
|---|---|
|—|_(対応するPracticeなし — 講義中心のトピック)_|

---

## 10. Biomechanics & Motion

### Lectures

| No          | Date       | Topic                                                            | Lecturer    |
| ----------- | ---------- | ---------------------------------------------------------------- | ----------- |
| Bio II - 10 | 2026.04.22 | Biological motion. Biomechanics, molecular and tissue mechanics. | Mártonfalvi |

### Practices

|Lab #|Topic|
|---|---|
|21|Resonance — Elasticity, oscillations, AFM _(Matter & Structureとも重複)_|

---

## 11. Organ Systems (Circulatory & Pulmonary)

### Lectures

| No          | Date       | Topic                                                   | Lecturer    |
| ----------- | ---------- | ------------------------------------------------------- | ----------- |
| Bio II - 13 | 2026.05.13 | Blood circulation and cardiac function.                 | Kiss Balázs |
| Bio II - 14 | 2026.05.20 | Biophysics of pulmonary function. Physical examination. | Kellermayer |

### Practices

|Lab #|Topic|
|---|---|
|27|ECG — Electrocardiography _(Bioelectricityとも重複)_|
|28|Flow — Fluid flow, vascular system model|
...
|Lab #|Topic|
|---|---|
|1|Introduction — General info, sample lab report|
|30|Appendix — Units, constants, safety rules, graph paper|
|31|Problems — Practice problems with answers|