...
- [[Development environment setup (rustup, cargo, VS Code + rust-analyzer)]] — _TRPL Ch. 1_
- [[Cargo basics (new, build, run, test, Cargo.toml)]] — _TRPL Ch. 1_
- [[Git & GitHub (repo creation, commit, push)]] — _external_
- Create `body-sim` repository

### Rust Fundamentals I — Ownership & Core Types — CORE

- [[Variables, data types, functions, control flow]] — _TRPL Ch. 2–3 / PR Ch. 2–3_
